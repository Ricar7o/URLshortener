...
Create a url shortening service like Bit.ly or TinyURL
...
- Write the service in ruby using whatever framework you prefer Rails, Sinatra, etc. Deploy the application to Heroku and add heroku@chaione.com as a collaborator.
